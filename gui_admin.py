...
class AdminInterface(tk.Tk):
    def __init__(self, admin_name, admin_id):
        ...
        # Logo
        logo_image_path = r"C:\Users\ASUS\Desktop\Interface\Files\Logo_of_IIT_Bhilai.png"
        ...
        self.stock_name_combobox = ttk.Combobox(stock_update_frame, values=item_name_options, width=30)
